...
const COOLDOWN_MS          = 2  * 60 * 1000;  // don't re-alert within 2 min
...
function start() {
  console.log(`✅ Offline Detection Service started (threshold: 8 s, active-window: 2 min, cooldown: 2 min, check interval: 3 s)`);
